...
class ContactoPage extends StatelessWidget {
  ...
  void _mandaCorreo() async {
    final Uri emailLaunchUri = Uri(
        ...
        queryParameters: {'subject': "Contacto", 'body': ''});
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
                border:
                    Border.all(width: 3, color: Colors.orangeAccent.shade100),
          ...
          Container(
            margin: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
            decoration: BoxDecoration(
              border: Border.all(width: 3, color: Colors.orangeAccent.shade100),
              borderRadius: BorderRadius.circular(8),
              boxShadow: [
                BoxShadow(
                  color: Colors.orangeAccent.shade100.withOpacity(0.5),
